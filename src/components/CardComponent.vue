<template>
  <div class="credit-card-container mx-auto w-full p-4 flex flex-wrap lg:flex-nowrap gap-8">
    <form @submit.prevent="handleSubmit" class="card-form w-full space-y-4 border border-1 p-4">
      <div class="flex flex-row gap-2">
        <div class="flex flex-col w-3/6">
          ...
          <div class="rounded-xl flex gap-4">
            <div class="rounded-xl expiry flex-1">
            ...
            <div class="rounded-xl cvv flex-1">
        ...
        <div class="w-3/6">
          <div class="card-preview relative w-full lg:w-full aspect-video perspective">
            <div
              class="card-front absolute w-full h-full rounded-lg p-6 bg-gradient-to-b from-[#32363b] to-[#32363b]/60 text-white transition-transform duration-500"
              :class="{ 'rotate-y-180': isCardFlipped }"
            >
              <div class="card-number text-xl tracking-widest mb-6 justify-center text-center">
                {{ formattedCardNumber || '•••• •••• •••• ••••' }}
              </div>
              <div class="card-info flex justify-between items-end h-[60%]">
