...
<template>
  ...
  <div class="flex flex-col justify-center items-center w-full pt-8  ">
    <form class="bg-white w-[45%] border border-1 rounded-md px-8 pt-6 pb-8 mb-4">
      ...
      <div class="w-full px-8 gap-8 flex">
        <!--CARTÃO-->
        <button type="button" class="border border-1 border-[#89a8f8] p-4 w-[24%] flex items-center gap-4 text-start rounded focus:outline-none focus:ring-2 focus:ring-[#89a8f8] focus:border-[#89a8f8]" :class="{'bg-blue-500/20': option == 1}" @click="option =1">
            <div>
            ...
            <p class="text-black w-[60%] text-xs">Pagamento no cartão</p>
        </button>
        ...
        <button type="button" class="border border-1 border-[#89a8f8] p-4 w-[24%] flex items-center gap-4 text-start rounded focus:outline-none focus:ring-2 focus:ring-[#89a8f8] focus:border-[#89a8f8]" :class="{'bg-blue-500/20': option == 2}" @click="option =2">
        ...
        <button  type="button" class="border border-1 border-[#89a8f8] p-4 w-[24%] flex items-center gap-4 text-start rounded focus:outline-none focus:ring-2 focus:ring-[#89a8f8] focus:border-[#89a8f8]" :class="{'bg-blue-500/20': option == 3}" @click="option=3">
      ...
      <div class="flex flex-col  " v-if="option==1">
        <CardComponent/>
      </div>
      <div class="w-[100%]"  v-if="option==2">
        <PixComponent/>
      </div>
      <div class=" w-full" v-if="option==3">
